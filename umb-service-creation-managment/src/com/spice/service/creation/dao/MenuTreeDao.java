...
public class MenuTreeDao {
	...
	public VariableApiMappingResponse variableApiMapping(VariableApiMappingRequest variableApiMapping) throws Exception {
		String str = "select app_id, variable_id from tbl_variable_api_mapping where app_id = ? limit 1";
		return jdbcTemplateObject.queryForObject(str, new Object[] {variableApiMapping.getAppId()}, 
				(rs, rowNum) -> new VariableApiMappingResponse(rs.getInt("app_id"), 
