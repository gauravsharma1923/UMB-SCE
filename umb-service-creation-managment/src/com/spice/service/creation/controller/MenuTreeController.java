...
public class MenuTreeController {
	...
	@RequestMapping(value = "/variableMapping", method = RequestMethod.POST)
	public ResponseObj variableApiMapping(@RequestBody VariableApiMappingRequest variableApiMapping, @RequestHeader String UserId) throws Exception
	{
		return menuTreeService.variableApiMapping(variableApiMapping);
	}
