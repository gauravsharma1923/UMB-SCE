...
public class DeploymentDao {
	...
	public List<ViewLogsResponse> deployViewLogs(DeployViewLogsRequest deployViewLogsRequest, String userId) throws Exception {
		...
		if(deployViewLogsRequest.getFromDate().isEmpty()) {
			return  jdbcTemplateObject.query(str,new Object[] {userId, deployViewLogsRequest.getDeploymentType(),0,0 }, new ViewLogsResponse());
		}else {
