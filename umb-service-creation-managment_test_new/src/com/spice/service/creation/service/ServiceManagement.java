...
public class ServiceManagement {
	...
	public ResponseObj updatesServiceStatus(ServiceStatus serviceStatus) throws Exception {
		...
		if (!"success".equalsIgnoreCase(verifyResponses.getString("OutStatus")))
			throw new GenericException(verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
					Integer.valueOf(verifyResponses.getString("OutResponseCode")));

		return new ResponseObj(null, verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
				Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	}
	...
	public ResponseObj createService(CreateServiceRequest createServiceRequest, String userId) throws Exception {
		...
		if (!"success".equalsIgnoreCase(verifyResponses.getString("OutStatus")))
			throw new GenericException(verifyResponses.getString("OutStatus"),
					"Duplicate service code. Please enter other code.",
					Integer.valueOf(verifyResponses.getString("OutResponseCode")));

		while (resultSet.next()) {
			createServiceResponse.setServiceId(resultSet.getString("service_id"));
		}
		return new ResponseObj(createServiceResponse, verifyResponses.getString("OutStatus"),
				verifyResponses.getString("OutDesc"), Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	}
	...
	public ResponseObj createServiceNode(CreateServiceNode createServiceNode, String userId) throws Exception {
		...
		return new ResponseObj(nodeResponse, verifyResponses.getString("OutStatus"),
				verifyResponses.getString("OutDesc"), Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	}
	...
	public ResponseObj createServiceNodeList(List<CreateServiceNode> createServiceNodeList, String userId)
			throws Exception {
		...
		while (itr.hasNext()) {
			...
			if (!"success".equalsIgnoreCase(verifyResponses.getString("OutStatus"))) {
				treeDao.deleteNode(createServiceNodeList.get(0).getParentId(), userId,
						createServiceNodeList.get(0).getServiceId());
				throw new GenericException(verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
						Integer.valueOf(verifyResponses.getString("OutResponseCode")));
			}
		}
		...
		return new ResponseObj(listResponse, verifyResponses.getString("OutStatus"),
				verifyResponses.getString("OutDesc"), Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	}
	...
	public ResponseObj updateServiceNodeList(List<UpdateServiceRequest> updateServiceRequest, String userId)
			throws Exception {
		CallableStatement verifyResponses = null;
		CreateServiceNodeListResponse listResponse = new CreateServiceNodeListResponse();
	...
	public ResponseObj updateNodeStatus(UpdateNodeStatusRequest updateNodeStatusRequest, String userId)
			throws Exception {
	...
	public ResponseObj createServiceMaster(CreateServiceMasterRequest createServiceMasterRequest, String userId)
			throws Exception {
		CallableStatement verifyResponses = serviceManagementDao.createServiceMaster(createServiceMasterRequest,
				userId);
		...
		return new ResponseObj(response, verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
				Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	}
	...
	public ResponseObj updateServiceDetail(UpdateServiceDetailRequest updateServiceDetailRequest, String userId)
			throws Exception {
		CallableStatement verifyResponses = serviceManagementDao.updateServiceDetail(updateServiceDetailRequest,
				userId);
		if (!"success".equalsIgnoreCase(verifyResponses.getString("OutStatus")))
			throw new GenericException(verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
					Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	...
	public ResponseObj cancelEditService(CancelEditServiceRequest cancelEditServiceRequest, String userId)
			throws Exception {
	...
	public ResponseObj keepAlive(KeepAliveRequest keepRequest) throws Exception {
		CallableStatement verifyResponses = serviceManagementDao.keepAlive(keepRequest);
		if (!"success".equalsIgnoreCase(verifyResponses.getString("OutStatus")))
			throw new GenericException(verifyResponses.getString("OutStatus"), verifyResponses.getString("OutDesc"),
					Integer.valueOf(verifyResponses.getString("OutResponseCode")));
	...
	public ResponseObj fetchServiceDetail(FetchServiceDetailRequest fetchServiceDetailRequest, String userId)
			throws Exception {
		...
		while (resultSet.next()) {
			response.add(new FetchServiceDetailResponse(resultSet.getString("service_id"),
					resultSet.getString("service_name"), resultSet.getString("service_code"),
					resultSet.getString("creator_id"), resultSet.getString("parent_service_id"),
					resultSet.getString("scope"), resultSet.getString("dcs"), resultSet.getString("circle"),
					resultSet.getString("status"), resultSet.getString("operator"),
					resultSet.getString("subscriber_type"), resultSet.getString("description"),
					resultSet.getString("created_on"), resultSet.getString("last_modify_by"),
	...
	public ResponseObj revokeRevisionService(RevokeRevisionRequest revokeRevisionRequest, String userId)
			throws Exception {
